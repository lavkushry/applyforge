    ...
    <Card className="space-y-4">
      ...
      <form className="grid gap-4 lg:grid-cols-2" onSubmit={handleSubmit((values) => mutation.mutate(values))}>
        ...
        <div className="space-y-2">
          ...
          <Input id="title" aria-describedby={errors.title ? "title-error" : undefined} {...register("title")} />
        ...
        <div className="space-y-2">
          ...
          <Input id="company" aria-describedby={errors.company ? "company-error" : undefined} {...register("company")} />
        ...
        <div className="space-y-2">
          ...
          <Input id="application_url" aria-describedby={errors.application_url ? "application_url-error" : undefined} {...register("application_url")} />
        ...
        <div className="space-y-2 lg:col-span-2">
          ...
          <Textarea id="description" aria-describedby={errors.description ? "description-error" : undefined} {...register("description")} className="min-h-[180px]" />

...
def wizard_summary(
    ...
    # ⚡ Bolt Optimization:
    # Consolidated 6 separate database calls into a single query using scalar subqueries.
    # This eliminates N+1 query patterns for dashboard-style endpoints, drastically
    # reducing database round-trips and speeding up load times.
    query = select(

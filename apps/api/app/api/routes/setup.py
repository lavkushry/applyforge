...
def wizard_summary(
    ...
    # ⚡ Bolt: Consolidated 6 separate DB queries into a single round-trip using scalar_subquery
    # Reduces multiple round-trips for independent dashboard counts and existence checks
    profile_basics_sq = (

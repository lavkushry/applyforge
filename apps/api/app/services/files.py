...
def validate_resume_upload(filename: str, mime_type: str | None, size_bytes: int) -> None:
    # Security: Normalize backslashes to prevent path traversal and extension bypass on POSIX
...
def save_upload(filename: str, content: bytes) -> str:
    ...
    # Security: Normalize backslashes to prevent path traversal on POSIX
    filename = filename.replace("\\", "/")
